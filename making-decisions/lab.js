...
if (temperature >= 80 && rain) {
  console.log("I'd recommend wearing a T-shirt and taking an umbrella today")
} else if (temperature > 60 && temperature < 80 && rain) {
  console.log("I'd recommend wearing a rainjacket today")
} else if (temperature <= 60 && rain) {
  console.log("I'd recommend wearing a jacket and taking an umbrella today")
} else if (temperature >= 80 && !rain) {
  console.log("A T-shirt for the day should be just fine")
} else if (temperature > 60 && temperature < 80 && !rain) {
  console.log("A light jacket for the day should be just fine")
} else {
  console.log("You may need a heavy jacket for the day")
}
